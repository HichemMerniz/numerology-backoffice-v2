export const translationsA = {
  fr: {
    ...
    'calculator.middleNames': 'Autres prénoms',
    'calculator.addMiddleName': 'Ajouter un prénom',
    ...
    'results.heredityNumber': "Nombre d'Hérédité",
    'results.heredityDescription': "Description du nombre d'hérédité",
    'results.inclusionGrid': "Grille d'inclusion",
    'results.letterAnalysis': 'Étude des lettres',
    ...
    'results.first': 'Première Réalisation',
    'results.second': 'Deuxième Réalisation',
    'results.third': 'Troisième Réalisation',
    'results.fourth': 'Quatrième Réalisation',
